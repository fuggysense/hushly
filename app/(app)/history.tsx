...
const styles = StyleSheet.create({
  ...
  back: { color: C.accent, fontSize: 16, width: 60 },
  ...
  timestamp: { color: C.textTertiary, fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5 },
  preview: { color: C.textPrimary, fontSize: 15, lineHeight: 22 },
  ...
  actionText: { color: C.textPrimary, fontSize: 13, fontWeight: '500' },
});
